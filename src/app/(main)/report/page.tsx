...
import { Camera, Loader2, Mic, MicOff, Send, Stethoscope, User, X } from 'lucide-react';
    ...
    <div className="container mx-auto max-w-3xl px-4 py-12">
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>
            Fill out the form below to report a health issue. A vet will be assigned automatically.
          </CardDescription>
        </CardHeader>
        <CardContent>
